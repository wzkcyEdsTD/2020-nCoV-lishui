  ...
  methods: {
    ...
    async goLogin() {
      ...
      if (this.form.username && this.form.password) {
        ...
        this.doMessage("请填写完整的用户名或密码", false);
      }
    },
...
.login {
  width: 100%;
  height: 100%;
  background-image: url("../common/image/login/nCovbak.jpg");
  .noShow {
    opacity: 0;
  }
  .container {
    ...
    .main {
      background-image: url("../common/image/login/loginarea.png");
      position: absolute;
      z-index: 100;
      width: 805px;
      height: 561px;
      ...
      .form {
        ...
        div {
          ...
          div {
            ...
            .icon_user {
              background-image: url("../common/image/login/user.png");
            }
            .icon_password {
              background-image: url("../common/image/login/password.png");
            }
            .form_text {
              width: 301px;
              height: 66px;
