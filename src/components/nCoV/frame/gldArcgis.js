...
export const getGLDList = (context, name, bid) => {
  loadModules(
    ...
    const queryTask = new QueryTask({
      url: `https://172.28.88.252:6443/arcgis/rest/services/lucheng/paiban/MapServer/5`
    });
...
export const getHMGLDList = (context, name, bid) => {
  loadModules(
    ...
    const queryTask = new QueryTask({
      url: `https://172.28.88.252:6443/arcgis/rest/services/lucheng/paiban/MapServer/7`
    });
    const query = new Query();
    query.outFields = ["*"];
    query.returnGeometry = true;
...
export const getHQGLDList = (context, name, bid) => {
  loadModules(
    ...
    const queryTask = new QueryTask({
      url: `https://172.28.88.252:6443/arcgis/rest/services/lucheng/paiban/MapServer/8`
    });
    const query = new Query();
    query.outFields = ["*"];
    query.returnGeometry = true;
...
export const getKFGLDList = (context, name, bid) => {
  loadModules(
    ...
    const queryTask = new QueryTask({
      url: `https://172.28.88.252:6443/arcgis/rest/services/lucheng/paiban/MapServer/12`
    });
    const query = new Query();
    query.outFields = ["*"];
    query.returnGeometry = true;
...
export const getNJQYList = (context, name) => {
  ...
  loadModules(
    ...
    const queryTask = new QueryTask({
      url: `https://172.28.88.252:6443/arcgis/rest/services/lucheng/nanjiao/MapServer/8`
    });
    const query = new Query();
    query.outFields = ["*"];
    query.returnGeometry = true;
