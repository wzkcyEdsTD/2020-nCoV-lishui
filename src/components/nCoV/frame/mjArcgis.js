...
export const mjChartUpdate = (context, name) => {
  ...
  loadModules(
    ...
    const queryTask = new QueryTask({
      url: `https://172.28.88.252:6443/arcgis/rest/services/lucheng/fangkong/MapServer/5`
    });
...
export const mjChartUpdate_gj = (context, name) => {
  ...
  loadModules(
    ...
    const queryTask = new QueryTask({
      url: `https://172.28.88.252:6443/arcgis/rest/services/lucheng/fangkong/MapServer/16`
    });
    const query = new Query();
    query.outFields = ["*"];
    query.returnGeometry = true;
